...
func (cs *ChaincodeServer) Start() error {
	...
	if !cs.TLSProps.Disabled {
		...
		fmt.Printf("cs.TLSProps.Key---,%v",cs.TLSProps.Key)
		fmt.Printf("cs.TLSProps.Cert---,%v",cs.TLSProps.Cert)
		fmt.Printf("cs.TLSProps.ClientCACerts---,%v",cs.TLSProps.ClientCACerts)
		if err != nil {
			return err
		}
	}
