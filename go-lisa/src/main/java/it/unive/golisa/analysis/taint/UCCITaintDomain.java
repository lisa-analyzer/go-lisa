...
/**
 * Taint analysis domain specific for untrusted cross contract invocation
 * issues. (for phase 2)
 */
public class UCCITaintDomain extends ThreeLevelsTaint {

	/**
	 * Set that contains untrusted cross contract invocations detected during
	 * the phase 1.
	 */
	Set<Call> uccis;
	 ...
	 * Builds the domain.
	 * 
	 * @param uccis the untrusted cross contract invocations detected during the
	 *                  phase 1
	 */
