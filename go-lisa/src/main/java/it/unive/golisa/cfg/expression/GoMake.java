...
public class GoMake extends NativeCall {
	...
	public <A extends AbstractState<A, H, V>,
		...
		if (type instanceof GoSliceType) {
			...
			AnalysisState<A, H, V> arraySemantics = array.semantics(lastPostState, interprocedural,
					new StatementStore<>(entryState));
		...
		if (type instanceof GoChannelType)
			return entryState.top().smallStepSemantics(new PushAny(Caches.types().mkSingletonSet(type), getLocation()),
					this);
