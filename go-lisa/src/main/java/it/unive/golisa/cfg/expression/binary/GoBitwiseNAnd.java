...
public class GoBitwiseNAnd extends BinaryNativeCall implements GoBinaryNumericalOperation {
	 ...
	 */
	public GoBitwiseNAnd(CFG cfg, SourceCodeLocation location, Expression exp1, Expression exp2) {
