...
/**
 * A Go greater or equal function call (e1 < e2). The static type of this
 * expression is definitely {@link GoBoolType}. The semantics of Go greater or
...
public class GoGreaterOrEqual extends BinaryNativeCall {
	...
	/**
	 * Builds a Go greater or equal expression at a given location in the
	 * program.
	 * 
							...
							V> tmp = rightState
									.smallStepSemantics(
											new BinaryExpression(Caches.types().mkSingletonSet(GoBoolType.INSTANCE),
													leftExp, rightExp, BinaryOperator.COMPARISON_GE, getLocation()),
											this);
