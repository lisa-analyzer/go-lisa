...
public class GoHasPrefix extends BinaryNativeCall{
	 ...
	 * @param exp2		    right-hand side operand
	 */
	public GoHasPrefix(CFG cfg, String sourceFile, int line, int col, Expression exp1, Expression exp2) {
		super(cfg, sourceFile, line, col, "strings.HasPrefix", GoBoolType.INSTANCE, exp1, exp2);
	}
	...
	protected <A extends AbstractState<A, H, V>, H extends HeapDomain<H>, V extends ValueDomain<V>> AnalysisState<A, H, V> binarySemantics(
		...
		return rightState.smallStepSemantics(new BinaryExpression(Caches.types().mkSingletonSet(GoBoolType.INSTANCE), leftExp, rightExp, BinaryOperator.STRING_STARTS_WITH));
	}
}
