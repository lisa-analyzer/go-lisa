...
/**
 * A Go less or equal function call (e1 < e2). The static type of this
 * expression is definitely {@link GoBoolType}. The semantics of Go less or
							...
							V> tmp = rightState
									.smallStepSemantics(
											new BinaryExpression(Caches.types().mkSingletonSet(GoBoolType.INSTANCE),
													leftExp, rightExp, BinaryOperator.COMPARISON_LE, getLocation()),
											this);
