...
public class Float64 extends NativeCFG {
	...
	public static class Float64Impl extends it.unive.lisa.program.cfg.statement.NaryExpression
		...
		public Float64Impl(CFG cfg, CodeLocation location) {
			super(cfg, location, "Float64Impl", GoFloat64Type.INSTANCE);
		}
		...
		public <A extends AbstractState<A, H, V>,
			...
			return state.smallStepSemantics(new PushAny(Caches.types().mkSingletonSet(GoFloat64Type.INSTANCE), getLocation()), original);
		}
	}
}
