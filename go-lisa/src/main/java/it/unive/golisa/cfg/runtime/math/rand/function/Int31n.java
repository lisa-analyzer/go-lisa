...
public class Int31n extends NativeCFG {
	 ...
	 */
	public Int31n(CodeLocation location, CodeUnit randUnit) {
		super(new CodeMemberDescriptor(location, randUnit, false, "Int31n", GoInt32Type.INSTANCE,
	...
	public static class Int31nImpl extends UnaryExpression
		 ...
		 */
		public Int31nImpl(CFG cfg, CodeLocation location, Expression expr) {
			super(cfg, location, "IntnImpl", GoInt32Type.INSTANCE, expr);
		}
		...
		public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
			...
			return interprocedural.getAnalysis().smallStepSemantics(state,
					new PushAny(GoInt32Type.INSTANCE, getLocation()), original);
		}
	}
}
