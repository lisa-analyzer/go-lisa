...
public class Int63 extends NativeCFG {
	 ...
	 */
	public Int63(CodeLocation location, CodeUnit randUnit) {
		super(new CodeMemberDescriptor(location, randUnit, false, "Int63", GoInt64Type.INSTANCE),
				Int63Impl.class);
	}
	...
	public static class Int63Impl extends it.unive.lisa.program.cfg.statement.NaryExpression
		...
		public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> forwardSemanticsAux(
			...
			return interprocedural.getAnalysis().smallStepSemantics(state, new PushAny(GoInt64Type.INSTANCE, getLocation()), original);
		}
	}
}
