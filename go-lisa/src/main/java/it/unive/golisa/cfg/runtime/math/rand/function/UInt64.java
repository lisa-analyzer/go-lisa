...
public class UInt64 extends NativeCFG {
	 ...
	 */
	public UInt64(CodeLocation location, CodeUnit randUnit) {
		super(new CodeMemberDescriptor(location, randUnit, false, "Uint64", GoUInt64Type.INSTANCE),
				UInt64Impl.class);
	}
	...
	public static class UInt64Impl extends it.unive.lisa.program.cfg.statement.NaryExpression
		...
		public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> forwardSemanticsAux(
			...
			return interprocedural.getAnalysis().smallStepSemantics(state, new PushAny(GoUInt64Type.INSTANCE, getLocation()), original);
		}
	}
}
