...
public class GetCreator extends NativeCFG {
	...
	/**
	 * The {@link GetCreator} implementation.
	 * 
	 * @author <a href="mailto:vincenzo.arceri@unipr.it">Vincenzo Arceri</a>
	 */
	public static class GetCreatorImpl extends UnaryExpression
		 ...
		 */
		public static GetCreatorImpl build(CFG cfg, CodeLocation location, Expression... params) {
			return new GetCreatorImpl(cfg, location, params[0]);
		}
