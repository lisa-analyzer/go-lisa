 ...
 * https://pkg.go.dev/github.com/hyperledger/fabric-chaincode-go/shim#ChaincodeStub.GetPrivateDataByPartialCompositeKey
 * 
 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
 */
public class GetPrivateDataByPartialCompositeKey extends NativeCFG {
	 ...
	 */
	public GetPrivateDataByPartialCompositeKey(CodeLocation location, CompilationUnit shimUnit) {
		super(new CodeMemberDescriptor(location, shimUnit, true, "GetPrivateDataByPartialCompositeKey",
				...
				GetPrivateDataByPartialCompositeKeyImpl.class);
	}

	/**
	 * The {@link GetPrivateDataByPartialCompositeKey} implementation.
	 * 
	 * @author <a href="mailto:luca.olivieri@univr.it">Luca Olivieri</a>
	 */
	public static class GetPrivateDataByPartialCompositeKeyImpl extends it.unive.lisa.program.cfg.statement.QuaternaryExpression
		 ...
		 */
		public static GetPrivateDataByPartialCompositeKeyImpl build(CFG cfg, CodeLocation location, Expression... params) {
			return new GetPrivateDataByPartialCompositeKeyImpl(cfg, location, params[0], params[1], params[2], params[3]);
		}
		 ...
		 */
		public GetPrivateDataByPartialCompositeKeyImpl(CFG cfg, CodeLocation location, Expression e1, Expression e2, Expression e3, Expression e4) {
			super(cfg, location, "GetPrivateDataByPartialCompositeKeyImpl", GoTupleType.getTupleTypeOf(location,
		...
		public <A extends AbstractState<A>> AnalysisState<A> fwdQuaternarySemantics(
			...
			for (SymbolicExpression id : reachableIds) {
				...
				TernaryExpression rExp = new TernaryExpression(GoErrorType.INSTANCE, derefId, e3, e4,
						GetPrivateDataByPartialCompositeKeyOperatorThirdParameter.INSTANCE, getLocation());
	 ...
	 */
	public static class GetPrivateDataByPartialCompositeKeyOperatorFirstParameter implements QuaternaryOperator {

		/**
		 * The singleton instance of this class.
		 */
		public static final GetPrivateDataByPartialCompositeKeyOperatorFirstParameter INSTANCE = new GetPrivateDataByPartialCompositeKeyOperatorFirstParameter();
		 ...
		 */
		protected GetPrivateDataByPartialCompositeKeyOperatorFirstParameter() {
		}

		@Override
		public String toString() {
			return "GetPrivateDataByPartialCompositeKeyOperator_1";
		}
	...
	/**
	 * The GetPrivateDataByPartialCompositeKey operator returning the second parameter of the tuple
	 * expression result.
	 * 
	 * @author <a href="mailto:vincenzo.arceri@unipr.it">Vincenzo Arceri</a>
	 */
	public static class GetPrivateDataByPartialCompositeKeyOperatorThirdParameter implements TernaryOperator {

		/**
		 * The singleton instance of this class.
		 */
		public static final GetPrivateDataByPartialCompositeKeyOperatorThirdParameter INSTANCE = new GetPrivateDataByPartialCompositeKeyOperatorThirdParameter();
		 ...
		 * singleton can be retrieved through field {@link #INSTANCE}.
		 */
		protected GetPrivateDataByPartialCompositeKeyOperatorThirdParameter() {
		}

		@Override
		public String toString() {
			return "GetPrivateDataByPartialCompositeKeyOperator_2";
		}
