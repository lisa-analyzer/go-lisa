 ...
 */
public class GetQueryResult extends NativeCFG {
	 ...
	 */
	public GetQueryResult(CodeLocation location, CompilationUnit shimUnit) {
		super(new CodeMemberDescriptor(location, shimUnit, true, "GetQueryResult",
				...
				GetQueryResultImpl.class);
	}

	/**
	 * The {@link GetQueryResult} implementation.
	 * 
	 * @author <a href="mailto:luca.olivieri@unive.it">Luca Olivieri</a>
	 */
	public static class GetQueryResultImpl extends it.unive.lisa.program.cfg.statement.BinaryExpression
		 ...
		 */
		public static GetQueryResultImpl build(CFG cfg, CodeLocation location, Expression... params) {
			return new GetQueryResultImpl(cfg, location, params[0], params[1]);
		}
		 ...
		 */
		public GetQueryResultImpl(CFG cfg, CodeLocation location, Expression left, Expression right) {
			super(cfg, location, "GetQueryResultImpl", GoTupleType
		...
		public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdBinarySemantics(
			...
			Collection<
					CodeMember> members = ((CompilationUnit) unit).getInstanceCodeMembersByName("GetQueryResult", true);
	...
	/**
	 * The GetQueryResult operator returning the first parameter of the tuple
	 * expression result.
	 * 
	 * @author <a href="mailto:luca.olivieri@unive.it">Luca Olivieri</a>
	 */
	public static class GetQueryResultOperatorFirstParameter implements BinaryOperator {

		/**
		 * The singleton instance of this class.
		 */
		public static final GetQueryResultOperatorFirstParameter INSTANCE = new GetQueryResultOperatorFirstParameter();
		 ...
		 */
		protected GetQueryResultOperatorFirstParameter() {
		}
	...
	/**
	 * The GetQueryResult operator returning the second parameter of the tuple
	 * expression result.
	 * 
	 * @author <a href="mailto:luca.olivieri@unive.it">Luca Olivieri</a>
	 */
	public static class GetQueryResultSecondParameter implements BinaryOperator {

		/**
		 * The singleton instance of this class.
		 */
		public static final GetQueryResultSecondParameter INSTANCE = new GetQueryResultSecondParameter();
		 ...
		 * singleton can be retrieved through field {@link #INSTANCE}.
		 */
		protected GetQueryResultSecondParameter() {
		}

		@Override
		public String toString() {
			return "GetQueryResultOperator_2";
		}
