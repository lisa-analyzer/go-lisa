...
public class PutPrivateData extends NativeCFG {
	...
	public PutPrivateData(CodeLocation location, CompilationUnit shimUnit) {
		super(new CodeMemberDescriptor(location, shimUnit, false, "PutState", GoErrorType.INSTANCE,
				...
				new Parameter(location, "value", GoSliceType.getSliceOfBytes())), PutPrivateDataImpl.class);
	}
	 ...
	 */
	public static class PutPrivateDataImpl extends NaryExpression implements PluggableStatement {
