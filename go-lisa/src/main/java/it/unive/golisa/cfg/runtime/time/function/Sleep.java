...
public class Sleep extends NativeCFG {
	 ...
	 */
	public Sleep(CodeLocation location, CodeUnit timeUnit) {
		super(new CodeMemberDescriptor(location, timeUnit, false, "Sleep",
				VoidType.INSTANCE,
				new Parameter(location, "d", Duration.INSTANCE)),
				SleepImpl.class);
	}

	/**
	 * The {@link Sleep} implementation.
	 * 
	 * @author <a href="mailto:vincenzo.arceri@unipr.it">Vincenzo Arceri</a>
	 */
	public static class SleepImpl extends UnaryExpression
		 ...
		 */
		public static SleepImpl build(CFG cfg, CodeLocation location, Expression[] exprs) {
