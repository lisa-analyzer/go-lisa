...
/**
 * Go 64 bits unsigned int type. It implements the singleton design pattern,
 * that is the instances of this type are unique. The unique instance of this
 * type can be retrieved by {@link GoUInt64Type#INSTANCE}.
 * 
 * @author <a href="mailto:vincenzo.arceri@unipr.it">Vincenzo Arceri</a>
 */
public class GoUInt64Type implements GoNumericType, Type {
