...
public class OverflowChecker implements SemanticCheck<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> {

	@Override
	public void beforeExecution(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool) {}

	@Override
	public void afterExecution(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool) {}

	@Override
	public boolean visitCompilationUnit(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool, CompilationUnit unit) {
		return true;
	}

	@Override
	public void visitGlobal(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool, Unit unit, Global global, boolean instance) {}

	@Override
	public boolean visit(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool, CFG graph) {
		return true;
	}

	@Override
	public boolean visit(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool, CFG graph, Statement node) {
		...
		if (leftExpression instanceof VariableRef) {
			...
			for (CFGWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> an : tool.getResultOf(graph)) {
				AnalysisState<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> analysisAtNode = an.getAnalysisStateAfter(node);
				Apron ap = (Apron) analysisAtNode.getState().getValueState();				
				BinaryExpression checkOver = new BinaryExpression(GoBoolType.INSTANCE, id, getMaxValue(vType), ComparisonGt.INSTANCE, leftExpression.getLocation());
				BinaryExpression checkUnder = new BinaryExpression(GoBoolType.INSTANCE, id, getMinValue(vType), ComparisonLt.INSTANCE, leftExpression.getLocation());
	...
	@Override
	public boolean visit(CheckToolWithAnalysisResults<GoAbstractState<Apron, TypeEnvironment<InferredTypes>>, GoPointBasedHeap, Apron, TypeEnvironment<InferredTypes>> tool, CFG graph, Edge edge) {
		return true;
	}
