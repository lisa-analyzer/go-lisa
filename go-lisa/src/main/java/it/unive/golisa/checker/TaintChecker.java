...
public class TaintChecker implements SemanticCheck<SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>,
MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>> {
	...
	public void beforeExecution(CheckToolWithAnalysisResults<
			SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>, MonolithicHeap,
			InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>> tool) {
	}

	@Override
	public void afterExecution(
			CheckToolWithAnalysisResults<SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>,
	...
	@Override
	public boolean visit(CheckToolWithAnalysisResults<SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>,
		...
		for (int i = 0; i < parameters.length; i++)
			if (parameters[i].getAnnotations().contains(SINK_MATCHER))
				for (Call call : tool.getCallSites(graph))
					for (CFGWithAnalysisResults<SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>,
							MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>> result : tool.getResultOf(call.getCFG()))
	...
	@Override
	public boolean visit(CheckToolWithAnalysisResults<SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>,
			MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>> tool, CFG graph, Statement node) {
	...
	@Override
	public boolean visit(CheckToolWithAnalysisResults<SimpleAbstractState<MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>>,
			MonolithicHeap, InferenceSystem<TaintDomain>, TypeEnvironment<InferredTypes>> tool, CFG graph, Edge edge) {
		return true;
	}
}
