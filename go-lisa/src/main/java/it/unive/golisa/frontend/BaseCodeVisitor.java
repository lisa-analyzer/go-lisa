...
public class BaseCodeVisitor extends GoParserBaseVisitor<Object> {

	private final Collection<ControlFlowStructure> cfs = new HashSet<>();

	private final Map<String, Set<IdInfo>> visibleIds = new HashMap<>();

	private final Map<Statement, String> gotos = new HashMap<>();

	private final Map<String, Statement> labeledStmt = new HashMap<>();
	...
	private final VariableScopingCFG cfg;
	...
	public BaseCodeVisitor(
			...
			VariableScopingCFG cfg,
			CFGDescriptor descriptor,
			AdjacencyMatrix<Statement, Edge, CFG> matrix) {
		this.file = file;
		this.matrix = matrix;
		this.cfg = cfg;
