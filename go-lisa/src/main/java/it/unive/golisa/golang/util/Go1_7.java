...
public class Go1_7 {
	...
	private void build0(){
		...
		mapConst.get("crypto/tls").add( new ConstGoLangApiSignature("crypto/tls", "RenegotiateOnceAsClient", " 1", null));
		mapType.get("crypto/tls").add( new TypeGoLangApiSignature("crypto/tls", "Config struct, Renegotiation RenegotiationSupport"));
		...
		mapConst.get("crypto/tls").add( new ConstGoLangApiSignature("crypto/tls", "RenegotiateNever", null, "RenegotiationSupport"));
		mapConst.get("crypto/tls").add( new ConstGoLangApiSignature("crypto/tls", "RenegotiateFreelyAsClient", null, "RenegotiationSupport"));
		mapType.get("crypto/tls").add( new TypeGoLangApiSignature("crypto/tls", "Config struct, DynamicRecordSizingDisabled bool"));
		mapConst.get("crypto/tls").add( new ConstGoLangApiSignature("crypto/tls", "RenegotiateFreelyAsClient", " 2", null));
		mapConst.get("crypto/tls").add( new ConstGoLangApiSignature("crypto/tls", "RenegotiateOnceAsClient", null, "RenegotiationSupport"));
		...
		mapType.get("syscall (linux-amd64-cgo)").add( new TypeGoLangApiSignature("syscall (linux-amd64-cgo)", "SysProcAttr struct, Unshareflags uintptr"));
		...
		mapType.get("syscall (linux-386)").add( new TypeGoLangApiSignature("syscall (linux-386)", "SysProcAttr struct, Unshareflags uintptr"));
		...
		mapFunc.get("os/user").add( new FuncGoLangApiSignature("os/user", "LookupGroup", new String[]{"string"}, new String[]{"*Group" ," error"}));
		mapMethod.get("os/user").add( new MethodGoLangApiSignature("os/user", "UnknownGroupError", "Error", new String[]{""}, new String[]{"string"}));
		...
		mapMethod.get("os/user").add( new MethodGoLangApiSignature("os/user", "UnknownGroupIdError", "Error", new String[]{""}, new String[]{"string"}));
		mapType.get("os/user").add( new TypeGoLangApiSignature("os/user", "Group struct"));
		mapMethod.get("os/user").add( new MethodGoLangApiSignature("os/user", "*User", "GroupIds", new String[]{""}, new String[]{"[]string" ," error"}));
		mapType.get("os/user").add( new TypeGoLangApiSignature("os/user", "Group struct, Gid string"));
		mapFunc.get("os/user").add( new FuncGoLangApiSignature("os/user", "LookupGroupId", new String[]{"string"}, new String[]{"*Group" ," error"}));
		...
		mapType.get("syscall (linux-arm-cgo)").add( new TypeGoLangApiSignature("syscall (linux-arm-cgo)", "SysProcAttr struct, Unshareflags uintptr"));
		...
		mapFunc.get("os/exec").add( new FuncGoLangApiSignature("os/exec", "CommandContext", new String[]{"context.Context" ," string" ," ...string"}, new String[]{"*Cmd"}));
		...
		mapConst.get("compress/flate").add( new ConstGoLangApiSignature("compress/flate", "HuffmanOnly", null, "ideal-int"));
		...
		mapMethod.get("testing, method (*B) Run(string").add( new MethodGoLangApiSignature("testing", "*B", "Run", new String[]{"string" ," func(*B"}, new String[]{") bool"}));
		...
		mapFunc.get("reflect").add( new FuncGoLangApiSignature("reflect", "StructOf", new String[]{"[]StructField"}, new String[]{"Type"}));
		mapMethod.get("reflect").add( new MethodGoLangApiSignature("reflect", "StructTag", "Lookup", new String[]{"string"}, new String[]{"string" ," bool"}));
		...
		mapMethod.get("strings").add( new MethodGoLangApiSignature("strings", "*Reader", "Reset", new String[]{"string"}, new String[]{""}));
		...
		mapFunc.get("net/http/httptest").add( new FuncGoLangApiSignature("net/http/httptest", "NewRequest", new String[]{"string" ," string" ," io.Reader"}, new String[]{"*http.Request"}));
		mapMethod.get("net/http/httptest").add( new MethodGoLangApiSignature("net/http/httptest", "*ResponseRecorder", "Result", new String[]{""}, new String[]{"*http.Response"}));
		...
		mapFunc.get("context").add( new FuncGoLangApiSignature("context", "WithTimeout", new String[]{"Context" ," time.Duration"}, new String[]{"Context" ," CancelFunc"}));
		mapVar.get("context").add( new VarGoLangApiSignature("context", "Canceled", "error"));
		mapType.get("context").add( new TypeGoLangApiSignature("context", "Context interface { Deadline, Done, Err, Value }"));
		mapType.get("context").add( new TypeGoLangApiSignature("context", "Context interface, Deadline() (time.Time, bool)"));
		mapFunc.get("context").add( new FuncGoLangApiSignature("context", "WithCancel", new String[]{"Context"}, new String[]{"Context" ," CancelFunc"}));
		mapFunc.get("context").add( new FuncGoLangApiSignature("context", "Background", new String[]{""}, new String[]{"Context"}));
		...
		mapFunc.get("context").add( new FuncGoLangApiSignature("context", "TODO", new String[]{""}, new String[]{"Context"}));
		mapFunc.get("context").add( new FuncGoLangApiSignature("context", "WithValue", new String[]{"Context" ," interface{}" ," interface{}"}, new String[]{"Context"}));
		mapFunc.get("context").add( new FuncGoLangApiSignature("context", "WithDeadline", new String[]{"Context" ," time.Time"}, new String[]{"Context" ," CancelFunc"}));
		mapType.get("context").add( new TypeGoLangApiSignature("context", "Context interface, Value(interface{}) interface{}"));
		...
		mapFunc.get("crypto/x509").add( new FuncGoLangApiSignature("crypto/x509", "SystemCertPool", new String[]{""}, new String[]{"*CertPool" ," error"}));
		...
		mapMethod.get("net").add( new MethodGoLangApiSignature("net", "*Dialer", "DialContext", new String[]{"context.Context" ," string" ," string"}, new String[]{"Conn" ," error"}));
		...
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, WroteHeaders func()"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "DNSStartInfo struct, Host string"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, DNSStart func(DNSStartInfo)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "GotConnInfo struct, IdleTime time.Duration"));
		mapFunc.get("net/http/httptrace").add( new FuncGoLangApiSignature("net/http/httptrace", "ContextClientTrace", new String[]{"context.Context"}, new String[]{"*ClientTrace"}));
		mapFunc.get("net/http/httptrace").add( new FuncGoLangApiSignature("net/http/httptrace", "WithClientTrace", new String[]{"context.Context" ," *ClientTrace"}, new String[]{"context.Context"}));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, PutIdleConn func(error)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, ConnectStart func(string, string)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, Got100Continue func()"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, DNSDone func(DNSDoneInfo)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, WroteRequest func(WroteRequestInfo)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "DNSDoneInfo struct"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "GotConnInfo struct, Reused bool"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, ConnectDone func(string, string, error)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "GotConnInfo struct, Conn net.Conn"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "DNSDoneInfo struct, Addrs []net.IPAddr"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "DNSStartInfo struct"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "WroteRequestInfo struct, Err error"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, GetConn func(string)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "WroteRequestInfo struct"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "DNSDoneInfo struct, Coalesced bool"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, GotConn func(GotConnInfo)"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "GotConnInfo struct, WasIdle bool"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, Wait100Continue func()"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "GotConnInfo struct"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "ClientTrace struct, GotFirstResponseByte func()"));
		mapType.get("net/http/httptrace").add( new TypeGoLangApiSignature("net/http/httptrace", "DNSDoneInfo struct, Err error"));
		...
		mapMethod.get("debug/dwarf").add( new MethodGoLangApiSignature("debug/dwarf", "*Data", "Ranges", new String[]{"*Entry"}, new String[]{"[][2]uint64" ," error"}));
		mapMethod.get("debug/dwarf").add( new MethodGoLangApiSignature("debug/dwarf", "*Reader", "SeekPC", new String[]{"uint64"}, new String[]{"*Entry" ," error"}));
		...
		mapMethod.get("math/big").add( new MethodGoLangApiSignature("math/big", "*Float", "GobEncode", new String[]{""}, new String[]{"[]uint8" ," error"}));
		mapMethod.get("math/big").add( new MethodGoLangApiSignature("math/big", "*Float", "GobDecode", new String[]{"[]uint8"}, new String[]{"error"}));
		...
		mapMethod.get("testing, method (*T) Run(string").add( new MethodGoLangApiSignature("testing", "*T", "Run", new String[]{"string" ," func(*T"}, new String[]{") bool"}));
		...
		mapMethod.get("runtime").add( new MethodGoLangApiSignature("runtime", "*Frames", "Next", new String[]{""}, new String[]{"Frame" ," bool"}));
		...
		mapFunc.get("runtime").add( new FuncGoLangApiSignature("runtime", "CallersFrames", new String[]{"[]uintptr"}, new String[]{"*Frames"}));
		mapType.get("runtime").add( new TypeGoLangApiSignature("runtime", "Frame struct, Function string"));
		mapFunc.get("runtime").add( new FuncGoLangApiSignature("runtime", "KeepAlive", new String[]{"interface{}"}, new String[]{""}));
		mapFunc.get("runtime").add( new FuncGoLangApiSignature("runtime", "SetCgoTraceback", new String[]{"int" ," unsafe.Pointer" ," unsafe.Pointer" ," unsafe.Pointer"}, new String[]{""}));
		...
		mapType.get("net/http").add( new TypeGoLangApiSignature("net/http", "Transport struct, DialContext func(context.Context, string, string) (net.Conn, error)"));
		mapMethod.get("net/http").add( new MethodGoLangApiSignature("net/http", "*Request", "Context", new String[]{""}, new String[]{"context.Context"}));
		mapType.get("net/http").add( new TypeGoLangApiSignature("net/http", "Transport struct, IdleConnTimeout time.Duration"));
		...
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusVariantAlsoNegotiates", null, "ideal-int"));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusInsufficientStorage", " 507", null));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusProcessing", null, "ideal-int"));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusUnprocessableEntity", " 422", null));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusUpgradeRequired", null, "ideal-int"));
		mapMethod.get("net/http").add( new MethodGoLangApiSignature("net/http", "*Request", "WithContext", new String[]{"context.Context"}, new String[]{"*Request"}));
		...
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusVariantAlsoNegotiates", " 506", null));
		...
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusPermanentRedirect", null, "ideal-int"));
		...
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusUnprocessableEntity", null, "ideal-int"));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusPermanentRedirect", " 308", null));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusInsufficientStorage", null, "ideal-int"));
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusFailedDependency", null, "ideal-int"));
		...
		mapType.get("net/http").add( new TypeGoLangApiSignature("net/http", "Transport struct, MaxResponseHeaderBytes int64"));
		...
		mapConst.get("net/http").add( new ConstGoLangApiSignature("net/http", "StatusAlreadyReported", null, "ideal-int"));
		...
		mapType.get("syscall (linux-arm)").add( new TypeGoLangApiSignature("syscall (linux-arm)", "SysProcAttr struct, Unshareflags uintptr"));
		...
		mapType.get("syscall (linux-386-cgo)").add( new TypeGoLangApiSignature("syscall (linux-386-cgo)", "SysProcAttr struct, Unshareflags uintptr"));
		...
		mapFunc.get("bytes").add( new FuncGoLangApiSignature("bytes", "ContainsAny", new String[]{"[]uint8" ," string"}, new String[]{"bool"}));
		mapMethod.get("bytes").add( new MethodGoLangApiSignature("bytes", "*Reader", "Reset", new String[]{"[]uint8"}, new String[]{""}));
		mapFunc.get("bytes").add( new FuncGoLangApiSignature("bytes", "ContainsRune", new String[]{"[]uint8" ," int32"}, new String[]{"bool"}));
		...
		mapMethod.get("encoding/json").add( new MethodGoLangApiSignature("encoding/json", "*Encoder", "SetEscapeHTML", new String[]{"bool"}, new String[]{""}));
		mapMethod.get("encoding/json").add( new MethodGoLangApiSignature("encoding/json", "*Encoder", "SetIndent", new String[]{"string" ," string"}, new String[]{""}));
		...
		mapMethod.get("debug/elf").add( new MethodGoLangApiSignature("debug/elf", "R_390", "GoString", new String[]{""}, new String[]{"string"}));
		...
		mapMethod.get("debug/elf").add( new MethodGoLangApiSignature("debug/elf", "R_390", "String", new String[]{""}, new String[]{"string"}));
		...
		mapType.get("syscall (linux-amd64)").add( new TypeGoLangApiSignature("syscall (linux-amd64)", "SysProcAttr struct, Unshareflags uintptr"));
