...
/**
 * The class represents the set of annotations for the non-determinism analysis related to Cosmos SDK
 * 
...
public class CosmosSDKNonDeterminismAnnotationSet extends NonDeterminismAnnotationSet {
	...
	/**
	 * Builds an instance of an annotation set for non-determinism related to Cosmos SDK
	 */
