...
/**
 * The class represents the set of annotations for the non-determinism analysis related to Hyperledger Fabric
 * 
...
public class HyperledgerFabricNonDeterminismAnnotationSet extends NonDeterminismAnnotationSet {
	...
	/**
	 * Builds an instance of an annotation set for non-determinism related to Hyperledger Fabric
	 */
