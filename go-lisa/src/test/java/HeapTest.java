...
public class HeapTest extends AnalysisTest {
	...
	public void fieldInsensitivePointBasedTest() throws AnalysisSetupException {
		perform("heap/field-insensitive", "go-structs.go", true, false, false, getDefaultFor(AbstractState.class, new PointBasedHeap(), new Interval()));
	}
	
	@Test
	public void fieldSensitivepointBasedTest() throws AnalysisSetupException {
		perform("heap/field-sensitive", "go-structs.go", true, false, false, getDefaultFor(AbstractState.class, new FieldSensitivePointBasedHeap(), new Interval()));
	}
}
